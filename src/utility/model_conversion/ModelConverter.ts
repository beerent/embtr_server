import { User, Task, PlannedDay, PlannedTask, PlannedDayResult, Notification } from '@prisma/client';

type PrismaModel = User | Task | PlannedDay | PlannedTask | PlannedDayResult | Notification;
